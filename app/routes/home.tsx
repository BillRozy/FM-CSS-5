...
export default function Home() {
  ...
  return (
    ...
    >
      <StyledPageContent
        className="tablet:py-32 desktop:grid grid-rows-[minmax(289px,1fr)_343px] grid-cols-2"
      ...
      >
        ...
        />
        <title>Home</title>
        <div className="flex flex-col gap-6 tablet:mx-[88px] desktop:mx-0 row-start-2 place-self-start text-blue-300">
